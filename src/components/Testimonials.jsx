...
const Testimonials = () => {
  const reviews = [
    ...
    },
    {
      ...
      content:
        "I use BharatWorks to track breakout projects from university campuses. The verified profiles give me confidence in who I'm speaking with.",
      rating: 4,
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, idx) => (
            ...
            >
              ...
              <blockquote className="text-gray-300 flex-grow mb-8 text-lg leading-relaxed italic">
                "{review.content}"
              </blockquote>

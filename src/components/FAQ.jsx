...
const FAQItem = ({ question, answer, isOpen, onClick }) => {
  return (
    <div className="border border-white/10 rounded-xl mb-4 overflow-hidden bg-black/20 backdrop-blur-sm transition-colors hover:bg-white/5">
      <button
...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Is BharatWorks free?",
      answer:
        "Yes, the core features of BharatWorks including networking, project discovery, and messaging are completely free for students and early-stage founders. We may introduce premium features for enterprises and advanced job postings in the future.",
    },
    {
    ...
    {
      question: "Who can join BharatWorks?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Currently, BharatWorks is optimized for the Indian innovation ecosystem, including localized events and startup discovery. However, the app can be downloaded globally via the App Store and Play Store for international collaboration.",
    },
  ];
